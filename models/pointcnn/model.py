...
class RandPointCNN_cls(nn.Module):

    def __init__(self, num_class=40):
        super().__init__()

        self.pcnn1 = RandPointCNN(3, 32, 3, 8, 1, -1, knn_indices_func_gpu)
        self.pcnn2 = nn.Sequential(
            RandPointCNN(32,    64,     3,  8,  2, -1,  knn_indices_func_gpu),
            RandPointCNN(64,    96,     3,  8,  4, -1,  knn_indices_func_gpu),
            RandPointCNN(96,    128,    3,  12, 4, 120, knn_indices_func_gpu),
            RandPointCNN(128,   160,    3,  12, 6, 120, knn_indices_func_gpu)
        )
